  ...
  return (
    <div className={style.howTo}>
      <div className={style.container}>
        ...
        <p>We're currently using <a href="https://unpkg.com/">unpkg</a> to serve these files. There is no build step requirement, but remember this is experimental and will not work in all browsers. You can check the support on <a href="https://ishoudinireadyyet.com">Is Houdini ready yet‽</a></p>
