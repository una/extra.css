  ...
  return (
    <div className={style.howTo}>
      <div className={style.container}>
        ...
        <p>
          The URLs are in the following format: <code>https://unpkg.com/extra.css/&lt;PackageName&gt;/&lt;FileType&gt;</code>You can grab any of the proper URLs by clicking on the links above for <strong>worklet</strong> and <strong>custom props</strong>. Here is an example of what your HTML and CSS could look like for the <code>Sparkles</code> example.
        </p>
