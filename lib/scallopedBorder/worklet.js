if (typeof registerPaint !== 'undefined') {
  class ScallopedBorder {
    ...
    paint(ctx, size, properties) {
      const radius = properties.get('--extra-scallopRadius').value || 10
      const scallopWeight = properties.get('--extra-scallopWeight') || 2
      const color = properties.get('--extra-scallopColor') || 'black'
