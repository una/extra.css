if (typeof registerPaint !== 'undefined') {
  class SuperUnderline {
    ...
    paint(ctx, size, properties) {
      const numUnderlines = properties.get('--extra-underlineNumber') || 3
      const lineWidth = properties.get('--extra-underlineWidth') || 2
      const color = properties.get('--extra-underlineColor') || 'black'
      const spread = properties.get('--extra-underlineSpread') || 20
